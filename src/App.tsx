...
const Demo = () => {
  ...
  return (
    <>
    <div className='w-full min-h-screen flex justify-center' style={{ backgroundImage: "url(/BgImg.jpg)", backgroundRepeat:"no-repeat" ,backgroundSize: "cover",backgroundPosition: "center" }}>
<Header/>
